    ...
    spawnEnemy() {
        ...
        if(!gridFilled){
            ...
            spawnAnim.on('animationcomplete', function() {
                ...
                var enemy = new Enemy(this, enemyTile, this.game.config.width, this.game.config.height, "enemy" + a,1);
            ...
            spawnAnim2.on('animationcomplete', function() {
                ...
                var enemy = new Enemy(this, enemyTile2, this.game.config.width, this.game.config.height, "enemy" + a,1);
                //Adding health for enemies
                enemy.hp = a; 
